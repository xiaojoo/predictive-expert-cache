...
def test_real_qwen_two_stage_longrun_stability() -> None:
    ...
    def loader(task: PrefetchTask) -> None:
        nonlocal stage1_completed, stage2_completed
    ...
    try:
        ...
        for step in range(longrun_steps):
            ...
            # ----------------------------------------------------------
            # Every completed Stage 1 must have completed Stage 2.
            # ----------------------------------------------------------
            assert stage1_completed == completed_total
            assert stage2_completed == completed_total
        ...
        print()
        print("7-O-6 Real Qwen -> Two-Stage Long-Run Stability")
        print("------------------------------------------------")
        ...
        print(f"NVMe -> RAM completed:     {stage1_completed}")
        print(f"RAM -> GPU completed:      {stage2_completed}")
